...
app.config['MYSQL_DATABASE_HOST'] = 'shan-database.c1i219fhvbx7.us-east-1.rds.amazonaws.com'
...
VALUES 
    ...
    ("Shan", "shan@clarusway.com"),
    ("Feyza", "feyza@apple.com"),
    ("Vincenzo", "vincenzo@clarusway.com"),
    ("Ali", "ali@google.com"),
    ("Zeki", "zeki@blabla.com"),
    ("Veli", "veli@ford.com");
"""
